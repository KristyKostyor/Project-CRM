...
import { postGood, addGoodPage } from "./data.js";
...
const addNewGoodFunction = () => {
  ...
  addNewGood.addEventListener("click", async (event) => {
    try {
      ...
      const generateId = () => getRandomInt(100000000, 999999999);
   ...
   if (!discount && description.length < 80) {
     ...
     return;
      ...
      <td class="table__cell-td">
       <button class="table__cell-btn"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button class="table__cell-btn"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button class="delBtn"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
